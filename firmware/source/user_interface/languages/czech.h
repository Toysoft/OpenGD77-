...
.menu					= "Menu", // MaxLen: 16
.credits				= "PõispevatelÈ", // MaxLen: 16
.zone					= "ZÛna", // MaxLen: 16
.rssi					= "Sila sign·lu", // MaxLen: 16
.battery				= "Baterie", // MaxLen: 16
.contacts				= "Kontakt", // MaxLen: 16
.firmware_info			= "Firmware Info", // MaxLen: 16
.last_heard				= "PoslednÌ volajÌcÌ", // MaxLen: 16
...
.private_call			= "Soukrom˝ Hovor", // MaxLen: 16
...
.factory_reset			= "Upln˝-Reset", // MaxLen: 16 (with ':' + .yes or .no)
...
.key_long				= "Drû", // MaxLen: 11 (with ':' + x.xs fitted)
...
.group_call				= "Group ÄÌsla", // MaxLen: 16
.all_call				= "Vsechny ÄÌsla", // MaxLen: 16
.tone_scan				= "CTCSS Sken",//// MaxLen: 16
.cc_scan				= "CC Sken",//// MaxLen: 16
.low_battery			= "SLAB¡ BATERIE!",//// MaxLen: 16
.Auto					= "Automatick˝", // MaxLen 16 (with .mode + ':') 
