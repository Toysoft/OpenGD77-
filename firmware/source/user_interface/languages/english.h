...
.batteryVoltage			= "%d.%dV", // MaxLen: 1 (volt symbol) ?needed?
...
.displayRxFreq			= "%d.%05d MHz", // MaxLen: 11
.accept_call			=  "Accept call?", // MaxLen: 16
.private_call			= "Private call", // MaxLen: 16
.squelch				= "Squelch", // MaxLen: 7
.vfoRxFreq				= "%cR %d.%05d MHz", // MaxLen: 8
.vfoTxFreq				= "%cT %d.%05d MHz", // MaxLen: 8
.vfoEnterFreq			= "%c%c%c.%c%c%c%c%c MHz", // MaxLen: 6
.quick_menu 			= "Quick Menu", // MaxLen: 16
.filter					= "Filter:%s", // MaxLen: 8 (settings: "None", "CC", "CC,TS", "CC,TS,TG")
.all_channels			= "All Channels", // MaxLen: 16
.gotoChannel			= "Goto %d",  // MaxLen: 11 ("1024")
.scan					= "Scan", // MaxLen: 16
...
.channelDetailsRx		= "Rx:%d.%05dMHz", // MaxLen: 16 (with freq fitted)
.channelDetailsTx		= "Tx:%d.%05dMHz", // MaxLen: 16 (with freq fitted)
.bandwidth				= "Bandwidth", // MaxLen: 16 (with ':' + .n_a, "25kHz" or "12.5kHz")
.stepFreq				= "Step:%d.%02dkHz", // MaxLen: 16 (with freq fitted)
...
.key_long				= "Key long:%1d.%1ds", // MaxLen: 16 ('%1d' is replaced by 1 digit, twice)
.key_repeat				= "Key rpt:%1d.%1ds", // MaxLen: 16 ('%1d' is replaced by 1 digit, twice)
