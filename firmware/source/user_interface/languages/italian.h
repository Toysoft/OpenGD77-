...
.ptt					= "PTT",
.locked					= "Bloccato",
.press_blue_plus_star	= "Premi Blue + *",
...
.timeout				= "TIMEOUT",
.tg_entry				= "Inserisci TG",
.pc_entry				= "Inserisci PC",
.user_dmr_id			= "DMR ID Utente",
.contact 				= "Contatto",
.accept_call			= "Accettare?",
.private_call			= "Chiamata Priv",
.squelch				= "Squelch",
...
.tot					= "TOT",
.off					= "Off",
.zone_skip				= "Salta Zona",
.all_skip				= "Salta Tutti",
.yes					= "Sì",
.no						= "No",
.rx_group				= "Rx Grp",
.on						= "On",
...
.delete_contact_qm		= "Canc. Contatto?",
.contact_deleted		= "Cancellato",
.contact_used			= "Contatto usato",
.in_rx_group			= "in gruppo RX",
.select_tx				= "Seleziona TX",
.edit_contact			= "Modif. Contatto",
