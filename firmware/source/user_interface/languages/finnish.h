...
.battery			= "Akun Tila",
.contacts			= "Kontaktit",
.firmware_info		= "Firmwaren tiedot",
.last_heard			= "Viimeksi kuultu",
.options			= "Asetukset",
.display_options	= "Näytön Asetuset",
.channel_details	= "Kanava Asetuset",
...
.timeSlot			= "Aikaslotti", // MaxLen: 16 (plus ':' and  .none, '1' or '2')
...
.YES				= "KYLLÄ", // MaxLen: 8 (choice above green/red buttons)
