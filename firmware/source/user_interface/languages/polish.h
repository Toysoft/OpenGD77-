...
.to_unlock				= "OdblokowaÇ", // MaxLen: 19
...
.tg_entry				= "Wejçcie TG", // MaxLen: 15
.pc_entry				= "Wejçcie PC", // MaxLen: 15
...
.timeSlot				= "Szczelina czasu", // MaxLen: 16 (plus ':' and  .none, '1' or '2')
.none					= "íaden", // MaxLen: 16 (with .timeSlot, "Rx CTCSS:" and ""Tx CTCSS:", and .filter)
...
.off					= "WyàÑzone", // MaxLen: 16 (with ':' + .timeout_beep, .calibration or .band_limits)
.zone_skip				= "Pomiã Zone", // MaxLen: 16 (with ':' + .yes or .no) 
.all_skip				= "Pomiã wszystko", // MaxLen: 16 (with ':' + .yes or .no)
...
.on					= "WàÑcz", // MaxLen: 16 (with ':' + .calibration or .band_limits)
.timeout_beep				= "Czas dêwiÜku", // MaxLen: 16 (with ':' + .off or 5..20)
.factory_reset				= "Reset ustawieã", // MaxLen: 16 (with ':' + .yes or .no)
.calibration				= "Kalibracja", // MaxLen: 16 (with ':' + .on or .off)
.band_limits				= "Limit pasma", // MaxLen: 16 (with ':' + .on or .off)
.beep_volume				= "GàoçnoçÇ dêwiÜku", // MaxLen: 16 (with ':' + -24..6 + 'dB')
.dmr_mic_gain				= "Siàa mikrofonu", // MaxLen: 16 (with ':' + -33..12 + 'dB')
.key_long				= "Key long", // MaxLen: 11 (with ':' + x.xs fitted)
.key_repeat				= "Key rpt", // MaxLen: 11 (with ':' + x.xs fitted)
.dmr_filter_timeout			= "Czas filtrowania", // MaxLen: 16 (with ':' + 1..90 + 's')
.brightness				= "JasnoçÇ", // MaxLen: 16 (with ':' + 0..100 + '%')
.contrast				= "Kontrast", // MaxLen: 16 (with ':' + 12..30)
.colour_invert				= "Kolor:Inny", // MaxLen: 16
.colour_normal				= "Kolor:Normalny", // MaxLen: 16
.backlight_timeout			= "Czas çwiecnia", // MaxLen: 16 (with ':' + 0..30)
.scan_delay				= "OpÛênienie skanu", // MaxLen: 16 (with ':' + 1..30 + 's')
...
.scan_mode				= "Tryb skanowania", // MaxLen: 16 (with ':' + .hold or .pause)
.hold					= "Zatrzymanie", // MaxLen: 16 (with ':' + .scan_mode)
.pause					= "Przerwa", // MaxLen: 16 (with ':' + .scan_mode)
.empty_list				= "Lista pusta", // MaxLen: 16
.delete_contact_qm			= "Kasuj kontakt?", // MaxLen: 16
.contact_deleted			= "Kontakt zmazany", // MaxLen: 16
...
.delete_contact				= "Kasacja kontaktu", // MaxLen: 16
.group_call				= "áÑcze grupowe", // MaxLen: 16
.all_call				= "áÑcze wszystkich", // MaxLen: 16
.tone_scan				= "Skanowanie ton.",//// MaxLen: 16
