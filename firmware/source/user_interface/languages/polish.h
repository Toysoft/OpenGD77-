...
.off					= "WyàÑczone", // MaxLen: 16 (with ':' + .timeout_beep, .calibration or .band_limits)
...
.beep_volume				= "GàoçnoçÇ bip", // MaxLen: 16 (with ':' + -24..6 + 'dB')
...
.dmr_filter_timeout			= "Filtrowanie", // MaxLen: 16 (with ':' + 1..90 + 's')
...
.backlight_timeout			= "Czas çwiecnia", // MaxLen: 16 (with ':' + .no to 30s)
