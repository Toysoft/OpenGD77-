 ...
 * VERY IMPORTANT. 
 *
 * DO NOT EDIT THIS FILE USING MCUEXPRESSO 
 * BECUASE IT USES THE ANSI CODEPAGE FOR ACCENTED CHARACTERS
 *
 * USE AN EDITOR LIKE NOTEPAD++ ON WINDOEW 
 * OR EMACS ON LINUX USING  windows-1252-unix ENCODING
 *
 ********************************************************************/
